...
namespace SPS.AEM.Web.Migrations
{
    ...
    [Migration("20200426064449_Description_Column_Added_To_LoadTypeTable_And_Data_Seed")]
    partial class Description_Column_Added_To_LoadTypeTable_And_Data_Seed
    {
            ...
            modelBuilder.Entity("SPS.AEM.Database.Entities.LoadType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Load test 1",
                            Type = "LT1"
                        },
                        new
                        {
                            Id = 2,
                            Description = "Load test 2",
                            Type = "LT2"
                        },
                        new
                        {
                            Id = 3,
                            Description = "Load test 3",
                            Type = "LT3"
                        },
                        new
                        {
                            Id = 4,
                            Description = "Load test 4",
                            Type = "LT4"
                        });
                });
